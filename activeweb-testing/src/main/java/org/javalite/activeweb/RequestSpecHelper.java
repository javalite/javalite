...
public class RequestSpecHelper extends SpecHelper{
    ...
    /**
     * Provides content generated by controller in the {@link JSONMap} format, after controller execution.
     *
    ...
    /**
     * Provides content generated by controller as an object, after controller execution.
     *
     * @return content generated by controller/view already converted to an object.
     */
    protected <T> T responseObject(Class<T> clazz){
        return JSONHelper.toObject(responseContent(), clazz);
    }
    /**
