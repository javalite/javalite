...
/**
     ...
     * {@link activeweb.annotations.RESTful}, then an action is open for GET requests. If a controller is
     * {@link activeweb.annotations.RESTful}, then the actions will conform to the restful routes.
     *
     * @param actionMethodName name of action method.
     * @return {@link activeweb.HttpMethod} this action will respond to.
     */
    ...
    /**
     * Returns true if this controller is configured to be {@link activeweb.annotations.RESTful}.
