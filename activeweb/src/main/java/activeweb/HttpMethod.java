...
public enum HttpMethod {
    ...
    public static HttpMethod method(Annotation annotation){
        ...
        if(annotation instanceof  activeweb.annotations.GET){
            return GET;
        }
        else if(annotation instanceof  activeweb.annotations.POST){
            return POST;
        }
        if(annotation instanceof  activeweb.annotations.PUT){
            return PUT;
        }
        if(annotation instanceof  activeweb.annotations.DELETE){
            return DELETE;
        }
        else{
