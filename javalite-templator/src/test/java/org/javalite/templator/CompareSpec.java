...
public class CompareSpec {
    ...
    @Test
    public void shouldProcessWithTemplator() {
        ...
        System.out.println("Templator completed in " + (System.currentTimeMillis() - millis) + " milliseconds");
    }


    @Test
    public void shouldProcessWithTemplateParser() throws IOException {
        ...
        System.out.println("TemplateParser completed in " + (System.currentTimeMillis() - millis) + " milliseconds");
    }
}
