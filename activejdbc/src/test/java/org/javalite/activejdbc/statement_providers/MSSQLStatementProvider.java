    ...
    public List<String> getPopulateStatements(String table) {
        ...
        if (table.equals("people")) {
            statements =  Arrays.asList(
                    ...
                    "INSERT INTO people (id, name, last_name, dob, graduation_date, created_at, updated_at) values(2, 'Leylah', 'Jonston', '1954-04-03', '1974-04-03', GETDATE(), GETDATE());",
                    "INSERT INTO people (id, name, last_name, dob, graduation_date, created_at, updated_at) values(3, 'Muhammad', 'Ali', '1943-01-04', '1963-01-04', GETDATE(), GETDATE());",
                    "INSERT INTO people (id, name, last_name, dob, graduation_date, created_at, updated_at) values(4, 'Joe', 'Pesci', '1944-02-23','1964-02-23', GETDATE(), GETDATE());"
            );
