...
IF object_id('dbo.patient_cards') IS NOT NULL
BEGIN
    DROP TABLE [dbo].[patient_cards]
END
CREATE TABLE patient_cards (id  INT IDENTITY PRIMARY KEY, info VARCHAR(56), patient_id INT);
