...
CREATE TABLE patient_cards (id  int(11) NOT NULL  auto_increment PRIMARY KEY, info VARCHAR(56), patient_id int(11));
...
CREATE TABLE passengers (id  int(11) NOT NULL auto_increment PRIMARY KEY, user_id INT(11) NOT NULL, vehicle VARCHAR(10), transportation_mode VARCHAR(10), created_at DATETIME, updated_at DATETIME);
