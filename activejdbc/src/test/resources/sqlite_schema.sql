...
CREATE TABLE patient_cards (id  INTEGER PRIMARY KEY AUTOINCREMENT , info VARCHAR(56), patient_id int(11));
...
CREATE TABLE passengers (id  INTEGER PRIMARY KEY AUTOINCREMENT, vehicle VARCHAR(56), transportation_mode VARCHAR(56), user_id INT(11));
...
CREATE TABLE genres (genre_id INTEGER PRIMARY KEY AUTOINCREMENT, name VARCHAR(56) NOT NULL);

DROP TABLE IF EXISTS musicians;
CREATE TABLE musicians (musician_id INTEGER PRIMARY KEY AUTOINCREMENT, first_name VARCHAR(56) NOT NULL, last_name VARCHAR(56) NOT NULL);

DROP TABLE IF EXISTS bands_genres;
CREATE TABLE bands_genres (the_id  INTEGER PRIMARY KEY AUTOINCREMENT, band_id INT(11), genre_id INT(11));
...
CREATE TABLE phone_numbers (id INTEGER PRIMARY KEY AUTOINCREMENT, number VARCHAR(56), type VARCHAR(56), scope VARCHAR(56), customer_id INT(11));
