...
/**
 * Event object. Sent to {@link activejdbc.cache.CacheManager} to let it know
...
public class CacheEvent {
    ...
    /**
     * Creates a new event type of {@link activejdbc.cache.CacheEvent.CacheEventType#GROUP}.
    ...
    /**
     * Creates a new event type of {@link activejdbc.cache.CacheEvent.CacheEventType#ALL}
     *
     * @param source string representation of source of event, whatever that means for the application. This event will
     * be broadcast to listeners, and they might use this piece of information. Can be null. 
     */
