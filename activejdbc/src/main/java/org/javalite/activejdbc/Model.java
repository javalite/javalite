...
public abstract class Model extends CallbackSupport implements Externalizable {
     ...
     *
     * <p/>
     * If {@link org.javalite.activejdbc.LazyList#include(Class[])} method was used, and this
     ...
     */
    protected static ValidationBuilder validateUniquenessOf(String... attributes) {
        return ValidationHelper.addUniquenessValidators(Model.<Model>getDaClass(), toLowerCase(attributes));
    }
    ...
    public EventObject createEvent(String eventType) {
        //TODO concrete class should control the event
        return null;
    }
