...
import static org.javalite.activejdbc.LogFilter.log;
...
public class MetaModel<T extends Model, E extends Association> implements Serializable {
    ...
    /**
     * Construct an abstract meta model which does not mapping to any table(leave to child model to decide)
     *
     * @param dbName the db name
     * @param modelClass the model class
     * @param dbType the db type
     * @param cached cached or not
     */
