...
public class Registry {
     ...
     * @return fetched meta parameters
     * @throws java.sql.SQLException db exception
     */
    ...
    public synchronized void addValidators(Class<Model> daClass, List<? extends Validator> modelValidators) {
        getValidators(daClass).addAll(modelValidators);
    }

    public synchronized void removeValidator(Class<Model> daClass, Validator validator) {
	 ...
	 */
    public void removeListener(Class modelClass, CallbackListener listener){
        getListeners(modelClass).remove(listener);
    }
}
